...
<div class="container">
    ...
    <ul>
        ...
        <li><a href="<?php print $home ?>/files/wee-read/Play Rhyme Time.pdf">Rhyme Time</a></li>
        ...
        <li><a href="<?php print $home ?>/files/wee-read/wee read handbook.pdf"><em>wee read</em> Handbook</a></li>
        <li><a href="<?php print $home ?>/files/wee-read/wee read volunteer handbook.pdf"><em>wee read</em> Volunteer Handbook</a></li>
    </ul>
