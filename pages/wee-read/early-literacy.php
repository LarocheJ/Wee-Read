...
<div class="container">
    ...
    <img class="rounded" src="<?php print $home ?>/images/stock/early-literacy.jpg" alt="Female reading with a child.">
    <p class=mt-2>&ldquo;Early literacy&rdquo; is everything children need to know about reading and writing to help them be ready to actually read and write. Early literacy skills begin to develop right from birth. Positive early experiences with books and language create the foundation for success in learning to read. This means helping a child continue to build <strong>Vocabulary</strong>, <strong>Print Awareness</strong>, <strong>Print Motivation</strong>, <strong>Narrative Skills</strong>, <strong>Letter Knowledge</strong>, and <strong>Phonological Awareness</strong>. You’ll learn more about each of these skills, and then move on to what you can do to help children develop them.</p>
    ...
    <p><strong>Print Awareness</strong> is knowing that the world is full of symbols and letters, and that they have meaning. The children you’re working with should know the concept of a &lsquo;word&rsquo; and how words work. Children should be able to recognize some of the words on the pages that you read with them.</p>
    ...
    <p><strong>Phonological Awareness</strong> is understanding that words are made up of sounds and that those sounds have symbols that represent them. The children that you’re working with should be able to use the knowledge they have about sounds to &ldquo;sound out&rdquo; easy words when reading them.</p>
