...
<div class="container">
    ...
    <div class="d-flex align-center">
        <div>
            <img class="tukay-img" src="<?php print $home ?>/images/tukay/Tukay_Spot_Finals6.png" alt="">
        </div>
        <div class="ml-3"> 
            <p class="mt-1">Babies aren&#39;t all born the same, thank goodness – the world needs everyone and all the things that make us unique! Some children are born visually impaired, non-hearing, and/or non-verbal, and there are ways that books and reading might be different for them, but still very important. </p>
