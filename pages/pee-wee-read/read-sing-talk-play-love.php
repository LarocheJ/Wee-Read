...
<div class="container">
    ...
    <div class="d-flex align-center">
        <div>
            <img class="rounded cropped" src="<?php print $home ?>/images/stock/IMG_7172.jpg" alt="Dad reading to his daughter under some drapes">
        </div>
        <div class="ml-1">
    ...
    <h2 class="cyan uppercase mt-1">Sing</h2>
    ...
    <div class="d-flex space-between">
        ...
        <div>
            <img class="rounded cropped" src="<?php print $home ?>/images/stock/Reading Place-33.jpg" alt="Dad reading to his daughter in the dark while his daughter is pointing a flashlight to illuminate the room">
        </div>
    </div>
