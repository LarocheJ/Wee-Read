...
<div class="container mb-5">
    ...
    <div class="d-flex justify-between align-middle steps">
        ...
        <div>
            ...
            <ul>
                ...
                <li>Make sure you give an orientation to all volunteers on school procedures, such as locations of classrooms and washrooms, emergency procedures, parking instructions, and important contacts.</li>
            </ul>
        </div>
    </div>
    <div class="d-flex justify-between align-middle steps">
        <div>
            ...
            <ul class="list-style-none">
                ...
                <li>	Printable Activities; The Name Game, Letter Hunt, Animal Sounds, Nursery Rhymes, and “50 Books to Read Before You Are 8” (master copies in the Resources Section)</li>
        ...
        <div>
            ...
            <ul class="list-style-none">
                ...
                <li>	Ensure books are age-appropriate for children three and four year olds</li>
    ...
    <div class="d-flex justify-between align-middle steps">
        <div>
            ...
            <p>Work with kindergarten and grade one teachers to develop a list of children who would benefit from the pee wee read program. The number of children you select will depend on the number of volunteers you have and the number of sessions they are able to provide each week. For example, if you have 10 volunteers who are willing to come to the school for an hour each week, they will be able to complete two sessions in that time. Based on two children per volunteer per session, this means that you can select 40 children. (Ideally, you should have two children per volunteer.)</p>
        ...
        <div>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <li>You will want to give a school tour to new volunteers; orient them to the office, introduce them to administrative staff and teachers, show them where the classrooms, reading spaces, and washrooms are, and review emergency procedures and school procedures (such as parking, etc).</li>
                </ul>
            </ul>
        </div>
    </div>
